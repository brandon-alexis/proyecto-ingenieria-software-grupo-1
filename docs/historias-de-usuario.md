...
- [x] HU-7: Como pasajero quiero ver la capacidad del bus.
...
- [x] HU-14: Como pasajero quiero recibir recomendaciones de rutas.
- [x] HU-15: Como conductor quiero reportar fallas.
- [x] HU-16: Como pasajero quiero pagar con distintos métodos.
- [x] HU-17: Como pasajero quiero calificar el servicio del conductor.
- [x] HU-18: Como administrador quiero actualizar la información de los buses para mantener los datos correctos.
- [ ] HU-19: Como administrador quiero editar paradas para corregir errores.
- [x] HU-20: Como pasajero quiero ver las paradas en el mapa para ubicarme.
- [x] HU-21: Como administrador quiero crear rutas asociando paradas.
- [ ] HU-22: Como administrador quiero modificar rutas para optimizar recorridos.
- [x] HU-23: Como pasajero quiero consultar rutas disponibles.
- [x] HU-24: Como usuario quiero validar mis datos al registrarme.
- [ ] HU-25: Como usuario quiero recibir confirmación de registro.
- [x] HU-26: Como pasajero quiero ver actualizaciones constantes de ubicación.
- [x] HU-27: Como pasajero quiero comparar la ubicación del bus con la mía.
- [ ] HU-28: Como administrador quiero editar información del sistema.
- [x] HU-29: Como administrador quiero eliminar registros obsoletos.
- [ ] HU-30: Como administrador quiero confirmar cambios realizados.
- [x] HU-31: Como pasajero quiero identificar paradas en la ruta.
- [ ] HU-32: Como pasajero quiero seguir el recorrido del bus.
- [x] HU-33: Como administrador quiero registrar la capacidad.
...
- [x] HU-38: Como pasajero quiero filtrar rutas.
...
- [x] HU-44: Como pasajero quiero comparar costos.
- [x] HU-45: Como pasajero quiero planificar mi gasto.
